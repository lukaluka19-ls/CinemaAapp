        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieDuration = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seats_MovieScreenings_MovieScreeningId",
                        column: x => x.MovieScreeningId,
                        principalTable: "MovieScreenings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationId1 = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationSeats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationSeats_Reservations_ReservationId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationSeats_ReservationId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_MovieScreeningId",
                table: "Seats",
                column: "MovieScreeningId");
        }
